...
/**
 * @file ObjectDetectionModuleModule.h
 * @brief Simple module as ObjectDetectionModule.
 */

#ifndef ObjectDetectionModule_H
#define ObjectDetectionModule_H


/**
 *
 * \defgroup icub_ObjectDetectionModuleThread icub_ObjectDetectionModuleThread
 ...
 *
 * - \c from \c icub_ObjectDetectionModule.ini \n
 *   specifies the configuration file
 *
 * - \c context \c icub_ObjectDetectionModule/conf \n
 *   specifies the sub-path from \c ICUB_ROOT/icub/app to the configuration file
 *
 * - \c name \c icub_interactionInterface \n
 *   specifies the name of the ObjectDetectionModuleThread (used to form the stem of ObjectDetectionModuleRateThread port names)
 *
 * - \c robot \c icub \n
 ...
 *    The port can be used by other ObjectDetectionModuleRateThreads but also interactively by a user through the yarp rpc directive, viz.: \c yarp \c rpc \c /ObjectDetectionModule
 ...
 *
 * \c interactionInterface.ini  in \c ICUB_ROOT/app/ObjectDetectionModule/conf \n
 *
 ...
 *
 * <tt>ObjectDetectionModule --name ObjectDetectionModule </tt>
 *
 * \author jonas gonzalez
 *
...
private:
    ...
    std::unique_ptr<ObjectDetectionThread> inferThread;
public:
    /**
    *  configure all the ObjectDetectionModuleModule parameters and return true if successful
